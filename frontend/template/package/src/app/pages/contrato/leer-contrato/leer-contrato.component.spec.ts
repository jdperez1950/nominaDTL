...
import { LeerContratoComponent } from './leer-contrato.component';
import { ContratoService } from '../../../services/ContratoService';

/**
 * Suite de pruebas para el componente LeerContrato
 */
describe('LeerContratoComponent', () => {
  // Variables para el componente y su fixture
  let component: LeerContratoComponent;
  let fixture: ComponentFixture<LeerContratoComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ LeerContratoComponent ],
      imports: [ 
   ...
   */
  beforeEach(() => {
    fixture = TestBed.createComponent(LeerContratoComponent);
