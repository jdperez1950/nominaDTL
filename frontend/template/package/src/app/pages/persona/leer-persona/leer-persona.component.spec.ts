...
import { LeerPersonaComponent } from './leer-persona.component';
import { PersonaService } from '../../../services/PersonaService';

/**
 * Suite de pruebas para el componente LeerPersona
 */
describe('LeerPersonaComponent', () => {
  // Variables para el componente y su fixture
  let component: LeerPersonaComponent;
  let fixture: ComponentFixture<LeerPersonaComponent>;
   ...
   */
  beforeEach(() => {
    fixture = TestBed.createComponent(LeerPersonaComponent);
