...
import { LeerDocumentoComponent } from './leer-documento.component';
import { DocumentoService } from '../../../services/DocumentoService';

/**
 * Suite de pruebas para el componente LeerDocumento
 */
describe('LeerDocumentoComponent', () => {
  // Variables para el componente y su fixture
  let component: LeerDocumentoComponent;
  let fixture: ComponentFixture<LeerDocumentoComponent>;
   ...
   */
  beforeEach(() => {
    fixture = TestBed.createComponent(LeerDocumentoComponent);
