...
import { LeerTipodocumentoComponent } from './leer-tipodocumento.component';
import { TipoDocumentoService } from '../../../services/TipoDocumentoService';

/**
 * Suite de pruebas para el componente LeerTipodocumento
 */
describe('LeerTipodocumentoComponent', () => {
  // Variables para el componente y su fixture
  let component: LeerTipodocumentoComponent;
  let fixture: ComponentFixture<LeerTipodocumentoComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ LeerTipodocumentoComponent ],
      imports: [ 
   ...
   */
  beforeEach(() => {
    fixture = TestBed.createComponent(LeerTipodocumentoComponent);
