...
import { LeerInformeComponent } from './leer-informe.component';
import { InformeService } from '../../../services/InformeService';

/**
 * Suite de pruebas para el componente LeerInforme
 */
describe('LeerInformeComponent', () => {
  // Variables para el componente y su fixture
  let component: LeerInformeComponent;
  let fixture: ComponentFixture<LeerInformeComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ LeerInformeComponent ],
      imports: [ 
   ...
   */
  beforeEach(() => {
    fixture = TestBed.createComponent(LeerInformeComponent);
