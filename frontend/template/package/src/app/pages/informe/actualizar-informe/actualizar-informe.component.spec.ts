...
import { ActualizarInformeComponent } from './actualizar-informe.component';
import { InformeService } from '../../../services/InformeService';

/**
 * Suite de pruebas para el componente ActualizarInforme
 */
describe('ActualizarInformeComponent', () => {
  // Variables para el componente y su fixture
  let component: ActualizarInformeComponent;
  let fixture: ComponentFixture<ActualizarInformeComponent>;
   ...
   */
  beforeEach(() => {
    fixture = TestBed.createComponent(ActualizarInformeComponent);
