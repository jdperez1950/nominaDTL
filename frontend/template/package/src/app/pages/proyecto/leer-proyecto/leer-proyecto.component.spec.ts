...
import { LeerProyectoComponent } from './leer-proyecto.component';
import { ProyectoService } from '../../../services/ProyectoService';

/**
 * Suite de pruebas para el componente LeerProyecto
 */
describe('LeerProyectoComponent', () => {
  // Variables para el componente y su fixture
  let component: LeerProyectoComponent;
  let fixture: ComponentFixture<LeerProyectoComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ LeerProyectoComponent ],
      imports: [ 
   ...
   */
  beforeEach(() => {
    fixture = TestBed.createComponent(LeerProyectoComponent);
