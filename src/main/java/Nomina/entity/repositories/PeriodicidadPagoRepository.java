...
/**
 * Repositorio JPA para la entidad PeriodicidadPago.
 ...
 */
@Repository
public interface PeriodicidadPagoRepository extends JpaRepository<PeriodicidadPago, Long> {

    /**
     * Busca entidades PeriodicidadPago por su relación OneToMany con Contrato.
